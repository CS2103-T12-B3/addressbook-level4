...
for the user to se ethe data without any stress. The theme is not bright but dark with subtle mix of blue added through+
google maps which complements the overall look of the app. Also, the image of the person is intended to be shown in a +
