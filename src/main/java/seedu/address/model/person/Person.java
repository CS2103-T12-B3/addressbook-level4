...
public class Person implements ReadOnlyPerson {
     ...
     */
    public Person(Name name, Phone phone, Email email, Address address, Birthday birthday, Photo photo, Set<Tag> tags) {
        requireAllNonNull(name, phone, email, address, birthday, photo, tags);
    ...
    public int hashCode() {
        ...
        return Objects.hash(name, phone, email, address, birthday, photo, tags);
    }
