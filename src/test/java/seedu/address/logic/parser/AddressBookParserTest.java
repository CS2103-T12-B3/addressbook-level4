...
public class AddressBookParserTest {
    ...
    public void parseCommand_list() throws Exception {
        ...
        assertTrue(parser.parseCommand(ListCommand.COMMAND_WORD + " t/friends") instanceof ListCommand);
        assertTrue(parser.parseCommand(ListCommand.COMMAND_WORD + " t/family") instanceof ListCommand);
    }
